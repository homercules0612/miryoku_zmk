...
#define MIRYOKU_ALTERNATIVES_NUM \
&kp AT,            &kp N7,            &kp N8,            &kp N9,            &kp SEMI,          &kp PLUS,          &kp MINUS,         &kp LPAR,          &kp RPAR,          &u_to_U_NUM,       \
...
#define MIRYOKU_ALTERNATIVES_SYM \
&kp AT,            &kp PIPE,          &kp AMPS,          &kp LBRC,          &kp RBRC,          &kp PLUS,          &kp MINUS,         &kp QMARK,         &kp EXCL,          &u_to_U_SYM,       \
