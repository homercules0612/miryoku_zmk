...
U_LT(U_BUTTON, X), U_MT(RALT, C),     &kp D,             &kp V,             &kp Z,             &kp K,             &kp H,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              U_EP_ON,           &kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        \
U_NA,              &kp RALT,          &u_to_U_FUN,       &u_to_U_MEDIA,     U_NA,              &u_out_tog,        &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp C_STOP,        &kp C_PP,          &kp C_MUTE,        U_NP,              U_NP
...
#define MIRYOKU_ALTERNATIVES_NUM \
&kp AT,            &kp N7,            &kp N8,            &kp N9,            &kp SEMI,          &kp PLUS,          &kp MINUS,         &kp LPAR,          &kp RPAR,          &u_to_U_BASE,      \
&kp CARET,         &kp N4,            &kp N5,            &kp N6,            &kp COLON,         &kp ASTRK,         &kp UNDER,         &kp LBRC,          &kp RBRC,          &kp LSHFT,         \
&kp TILDE,         &kp N1,            &kp N2,            &kp N3,            &kp QMARK,         &kp FSLH,          &kp BSLH,          &kp HASH,          &kp DLLR,          &kp LCTRL,         \
...
#define MIRYOKU_ALTERNATIVES_SYM \
&kp AT,            &kp PIPE,          &kp AMPS,          &kp LBRC,          &kp RBRC,          &kp PLUS,          &kp MINUS,         &kp QMARK,         &kp EXCL,          &u_to_U_BASE,      \
&kp CARET,         &kp EXCL,          &kp PRCNT,         &kp LPAR,          &kp RPAR,          &kp ASTRK,         &kp UNDER,         &kp LT,            &kp GT,            &kp DQT,           \
&kp TILDE,         &kp DLLR,          &kp HASH,          &kp LBKT,          &kp RBKT,          &kp FSLH,          &kp BSLH,          &kp SEMI,          &kp COLON,         &kp APOS,          \
U_NP,              U_NP,              &kp DOT,           &kp N0,            &kp EQUAL,         U_NA,              U_NA,              &kp BSPC,          U_NP,              U_NP
